...
rm(GO_annotations, mart, getinfo, efit, DE_info)
```
<br>
...
There doesn't seem to be a relation between level of expression and the binned scores for any of the diseases. This is weird because in Gandal's dataset we found there was a statistically significant difference
<br>
...
When separating the genes that belong to the SFARI Genes, the bias in mean expression in the genes related to Depressive Disorder and in SFARI Genes becomes statistically significant
```{r, warning=FALSE, message=FALSE, fig.width=10, fig.height=6}
...
There is a significant relation between level of expression and DisGeNET scores in ASD and Depressive Disorder, but the last one, only when selecting the SFARI Genes

We didn't find a strong relation between level of expression in any of the diseases as we had found in Gandal's dataset
