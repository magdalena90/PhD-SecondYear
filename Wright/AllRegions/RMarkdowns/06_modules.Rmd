...
```{r pca_plots, warning=FALSE, fig.align='center'}
...
```{r plot_heatmap, fig.width=10, fig.height=25, warning=FALSE, message=FALSE}
...
```{r MD_LFC_boxplot, fig.width=12, warning=FALSE, message=FALSE}
...
- Mdules with a high negative Module-Diagnosis correlation are the ones with the lowest trend of Enrichment on SFARI Genes<span style="color:red">(!)</span>
