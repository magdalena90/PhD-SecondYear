---
title: 'Old SFARI Genes Classification Model'
output:
  html_document:
    code_folding: 'hide'
---
...
```{r pca_obs, fig.align='center', warning=FALSE, message=FALSE}
...
The only difference is that we now have a slightly larger proportion of positive observations than before (`r round(mean(dataset$SFARI)*100,2)`%)
...
The model has an AUC of `r round(fit$results$ROC,4)`, but, as before, the features are strongly correlated
