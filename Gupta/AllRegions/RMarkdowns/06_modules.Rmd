...
- SFARI Score 1 has the highest Module-Diagnosis distribution of all groups
...
There doesn't seem to be a strong relation between these two metrics, perhaps the modules with the largest negative Module-Diagnosis correlation have higher Enrichment in SFARI Genes than the rest of the dataset
...
- Mdules with a high Module-Diagnosis correlation are the ones with the lowest trend of Enrichment on SFARI Genes<span style="color:red">(!)</span>

- Modules with a high (negative) Module-Diagnosis correlation are the ones with the highest Enrichment in SFARI Genes
...
- Modules with negative Module-Diagnosis correlation have a higher enrichment in SFARI Genes than the genes with a positive Module-Diagnosis correlation
